...
<div class="content">
	<div id="mainleft">
		<h1>WELCOME TO THE ARMADA! <br />(this website is currently under construction)</h1>
		<hr>
	...
	<div id="mainright">
		...
		<hr>
		<hr>
		<h3>Trigger Armada does not currently have any shows scheduled, we're writing new music!  <a class="one" href="index.php">Contact us</a> for booking inquiries!</h3>
